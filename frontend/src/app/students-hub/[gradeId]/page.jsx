...
export default function GradeMaterialPage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-16">
      ...
      {/* Grade Header */}
      <div className="bg-gray-100 text-gray-900 pt-10 pb-16 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <Link href="/students-hub" className="inline-flex items-center text-gray-900 hover:text-gray-900 font-medium mb-6 transition-colors">
          ...
          <p className="text-lg text-gray-900 font-medium">Access your comprehensive study notes and previous year questions below.</p>
        </div>
      </div>
